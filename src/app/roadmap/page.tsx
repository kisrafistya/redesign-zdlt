  ...
  '2025': {
    'Q3': [
      {
        ...
        description: 'Launch the complete redesign reflecting the new ZiroDelta brand identity across all web properties.',
        status: 'in-progress'
      },
      {
      ...
      },
      {
        ...
        description: 'Upgrade backend architecture to handle 1 000 concurrent bot users; migrate to institutional-grade infra.',
        status: 'planned'
      },
      {
      ...
      },
      {
        ...
        description: 'Kick off the premium merchandise store with ZDLT-exclusive items to fuel community engagement and brand visibility.',
        status: 'planned'
      },
      {
    ...
    'Q4': [
      ...
      },
      {
        ...
        description: 'Commission third-party audit focusing on conditional token logic & oracle manipulation resistance.',
        status: 'planned'
      },
      {
  ...
  '2026': {
    'Q1': [
      ...
      },
      {
        ...
        description: 'Iterate on merch collections, introduce limited drops and integrate on-chain rewards sourced from merch revenue.',
        status: 'planned'
      },
      {
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 py-24 sm:py-32">
        <div className="w-full max-w-7xl mx-auto z-10">
          ...
          <div className="text-center mb-16 sm:mb-20">
            <h1 className="text-4xl sm:text-6xl font-bold text-brand-emerald dark:text-white mb-6" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              Roadmap
            </h1>
            <p className="text-lg sm:text-xl text-brand-emerald dark:text-white mb-6 max-w-2xl mx-auto leading-relaxed" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              Our journey to revolutionize decentralized finance, where intelligence meets innovation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="relative">
              ...
              <img src="/q3-substract.svg" alt="" className="w-full h-auto" />
              ...
              <div className="absolute inset-0 p-12 text-white dark:text-slate-700 z-10 flex flex-col justify-start">
                <div className="space-y-6 mt-20">
                  <div className="flex items-start space-x-4">
                    <img src="/star-green.svg" alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white dark:text-slate-700 text-base font-medium leading-relaxed">Brand-aligned web redesign reflecting new ZiroDelta identity across all properties.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <img src="/star-green.svg" alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white dark:text-slate-700 text-base font-medium leading-relaxed">Broker partnerships & infrastructure scale-up for 1,000 concurrent users.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <img src="/star-green.svg" alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white dark:text-slate-700 text-base font-medium leading-relaxed">Public beta launch with 10-bot redundancy system and performance monitoring.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <img src="/star-green.svg" alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white dark:text-slate-700 text-base font-medium leading-relaxed">Referral programme, PnL flex cards, and comprehensive security stress-testing.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <img src="/star-green.svg" alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white dark:text-slate-700 text-base font-medium leading-relaxed">Merch flywheel launch with ZDLT-exclusive premium merchandise store.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              ...
              <img src="/q4-Subtract.png" alt="" className="w-full h-auto" />
              ...
              <div className="absolute inset-0 p-12 text-white dark:text-slate-700 z-10 flex flex-col justify-start">
                <div className="space-y-6 mt-20">
                  <div className="flex items-start space-x-4">
                    <img src="/star-green.svg" alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white dark:text-slate-700 text-base font-medium leading-relaxed">ZiroDelta Protocol architecture finalization for PFRT/NFRT conditional tokens.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <img src="/star-green.svg" alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white dark:text-slate-700 text-base font-medium leading-relaxed">Multi-source oracle framework PoC with funding-rate data integration.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <img src="/star-green.svg" alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white dark:text-slate-700 text-base font-medium leading-relaxed">PFRT/NFRT devnet deployment with basic mint/redeem functionality.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <img src="/star-green.svg" alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white dark:text-slate-700 text-base font-medium leading-relaxed">Protocol security audit focusing on conditional token logic & oracle security.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <img src="/star-green.svg" alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white dark:text-slate-700 text-base font-medium leading-relaxed">Mainnet readiness preparation with liquidity-mining incentive design.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {Object.entries(roadmapData['2026']).map(([quarter, items]) => (
                <div key={quarter} className="bg-white/5 dark:bg-black/20 backdrop-blur-sm rounded-2xl p-6 border border-brand-emerald/20">
                  <h3 className="text-xl font-semibold text-brand-emerald dark:text-white mb-4">{quarter} 2026</h3>
                  <div className="space-y-4">
                    {items.map((item, index) => (
                      <div key={index} className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-brand-emerald rounded-full mt-2 flex-shrink-0"></div>
                        <div>
